...
public class Mail_java {
	public static void main(String[] args) throws Exception {
		...
		ts.connect("smtp.qq.com", "你的QQ", "prktb修改为自己的jhvbajj");
		// 创建邮件
	...
	public static MimeMessage createSimpleMail(Session session) throws Exception {
		...
		// 指明邮件的发件人
		message.setFrom(new InternetAddress("7修改为自己的9@qq.com"));
		// 指明邮件的收件人，现在发件人和收件人是一样的，那就是自己给自己发
		message.setRecipient(Message.RecipientType.TO, new InternetAddress("修改为自己的@qq.com"));
		// 邮件的标题
